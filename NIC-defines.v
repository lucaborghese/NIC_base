...
`define	CMD_BITS_HEAD_FLIT				24:20
`define	N_BIT_CMD_HEAD_FLIT				5
`define	SRC_BITS_HEAD_FLIT				30:25
`define	N_BIT_SRC_HEAD_FLIT				6
`define	DEST_BITS_HEAD_FLIT				36:31
`define	N_BIT_DEST_HEAD_FLIT				6
`define	HEAD_FLIT_ADDRESS_BITS			63:32
